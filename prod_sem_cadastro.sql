...
select distinct cast(codinf as varchar(13)), ite_cod_interno, ite_descricao, ite_ttr_codigo
from codigos left join tabitens on codinf = ite_codbarra
where ite_cod_interno is not null or ite_ttr_codigo='999'
